...
//        return builder.build();
    ...
    // # mongodb://admin:fantoo1234@mongodb01:27017,mongodb02:27017,mongodb03:27017/fantoo_chat_live?authSource=admin&replicaSet=chatsvr-rs-0&retryWrites=true&w=majority
    private ConnectionString getConnectionString() {
        String str = String.format("mongodb://%s:%s@%s:%s/%s?retryWrites=false",
                user,
                password,
                host,
                port,
